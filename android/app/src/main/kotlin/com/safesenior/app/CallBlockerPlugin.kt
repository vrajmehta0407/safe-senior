...
/**
 * Flutter â†” Android MethodChannel bridge for call blocking.
 *
 * Exposes two methods to Flutter:
 *   - requestCallScreeningRole â†’ triggers the system role-request dialog
 *   - isCallScreeningRoleHeld  â†’ returns true/false
 *
 * Listens for:
 *   - checkBlocklist(phoneNumber: String) â†’ Boolean  (called from CallScreeningService)
